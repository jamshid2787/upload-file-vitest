...
describe('multipleUpload', () => {
	...
	it('should display error message when exceeding max file count', async () => {
		...
		(mockFileList[0] = new File(['File content'], 'file1.txt', { type: 'text/plain' })),
			(mockFileList[1] = new File(['Another file content'], 'file2.txt', { type: 'text/plain' })),
			(mockFileList[2] = new File(['Another file content'], 'file3.txt', { type: 'text/plain' })),
			(mockFileList[3] = new File(['Another file content'], 'file4.txt', { type: 'text/plain' })),
			(mockFileList[4] = new File(['Another file content'], 'file5.txt', { type: 'text/plain' })),
			(mockFileList[5] = new File(['Another file content'], 'file6.txt', { type: 'text/plain' })),
			(mockFileList[6] = new File(['Another file content'], 'file7.txt', { type: 'text/plain' })),
